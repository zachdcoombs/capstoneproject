 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newUser.aspx.cs" Inherits="CapstoneProject.home" %>
            ...
            <div class="col-md-4 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form id="addUserForm" runat="server">
                  ...
                  <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" type="submit" runat="server" id="btnAddUser" onserverclick="btnLogin_Click1">Add User</button>
                  </div>
                </form>
